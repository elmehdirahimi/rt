...
void 		GetAngleSphere(t_object *sphere_temp , t_vect inter);
void 		GetAngleCylinder(t_object *sphere_temp , t_vect inter);
void 	GetAngleCone(t_object *sphere_temp , t_vect inter);
void 		GetAnglePlan(t_object *plane_temp , t_vect inter);
